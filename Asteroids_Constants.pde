...
public static class AsteroidConstants {
    ...
    public static boolean enableLogs = false; //Only on logging purpose set this flag to true, else there may be significant performance issues. YOU HAVE BEEN WARNED
